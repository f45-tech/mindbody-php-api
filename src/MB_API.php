...
class MB_API
{
    ...
    */
    public function __construct($sourceCredentials = array(), $userCredentials = array())
    {
        ...
        //set userCredentials
        if (!empty($userCredentials) and !empty($sourceCredentials)) {
            ...
            if (!empty($sourceCredentials['SiteIDs'])) {
                if (is_array($sourceCredentials['SiteIDs'])) {
                    $this->userCredentials['SiteIDs'] = $sourceCredentials['SiteIDs'];
                } else if (is_numeric($sourceCredentials['SiteIDs'])) {
                    $this->userCredentials['SiteIDs'] = array($sourceCredentials['SiteIDs']);
                }
            }
        }
    }
